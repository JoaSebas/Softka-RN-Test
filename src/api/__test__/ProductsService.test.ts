...
describe('ProductsService', () => {
  ...
  it('should fetch and return all products', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('http://192.168.7.13:3002/bp/products');
  });
  ...
  it('should verify if a product ID exists', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('http://192.168.7.13:3002/bp/products/verification/123');
  });
  ...
  it('should create a product', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('http://192.168.7.13:3002/bp/products', expect.any(Object));
  });
  ...
  it('should update a product', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('http://192.168.7.13:3002/bp/products/123', expect.any(Object));
  });
  ...
  it('should delete a product', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('http://192.168.7.13:3002/bp/products/123', { method: 'DELETE' });
  });
});
